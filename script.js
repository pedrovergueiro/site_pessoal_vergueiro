...
function analyzeSentiment() {
    ...
    if (result) {
        result.innerHTML = `
            ...
            <div class="${className}" style="font-size: 18px; margin-bottom: 16px; padding: 12px; background: rgba(99,102,241,0.1); border-radius: 8px; text-align: center;">
...
function recommendMovies() {
    ...
    if (result) {
            ...
            html += `
                <div class="movie-item" style="animation-delay: ${index * 0.1}s; margin-bottom: 12px;">
                    <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 8px;">
                        ...
                        <div class="movie-rating" style="background: rgba(99,102,241,0.2); padding: 2px 8px; border-radius: 12px; font-size: 11px;">⭐ ${movie.rating}</div>
                    </div>
                    <div style="color: #6366f1; font-size: 11px; margin-bottom: 4px; font-weight: 500;">${movie.genre}</div>
        ...
        html += `
            <div style="margin-top: 20px; padding: 12px; background: rgba(99,102,241,0.1); border-radius: 8px; font-size: 12px;">
...
function updateBalance() {
    ...
    if (balanceElement) {
        ...
        balanceElement.style.color = '#6366f1';
        setTimeout(() => {
